    ...
    >
      <div className="mx-auto h-[43rem] w-full max-w-[95%] pt-1 lg:mt-[2rem]  text-slate-900">
        ...
        <section className={`grid grid-cols-4 items-start gap-2 ${layoutClass} h-[90%]`}>
          <div className="sm:h-[20rem] md:h-full rounded-2xl border border-slate-200 px-2 py-3 shadow-sm sm:col-span-1 col-span-2 bg-white/80 overflow-auto subject-scrollbar">
          ...
          <div className="sm:h-[20rem] md:h-full rounded-2xl border border-slate-200  px-2 py-3 sm:col-span-1 bg-white/80 col-span-2 shadow-sm overflow-auto subject-scrollbar">
          ...
          {selectedSection && hasSubsections ? (
            ...
            <>
              <div className="sm:h-[20rem] md:h-full rounded-2xl border border-slate-200 bg-white/80 p-3 col-span-2 shadow-sm sm:col-span-1">
                <div className="mb-3 text-sm font-semibold text-slate-700">
                  Subsections
                </div>
                <p className="text-sm text-slate-500">Coming soon</p>
