      ...
      <aside className="grid gap-5 self-start xl:sticky xl:top-6">
        <div className={panel}>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
            ...
            <div className="rounded-3xl border border-stone-900/10 bg-white/70 p-4">
              <strong className="block font-['Sora'] text-3xl text-stone-900">{test.totalQuestions - answeredCount}</strong>
        ...
        <div className={panel}>
          ...
          <div className="mt-5 grid gap-2 text-sm text-stone-600">
            <span className="flex items-center gap-2"><i className="h-3 w-3 rounded-full bg-emerald-600" />Answered</span>
            <span className="flex items-center gap-2"><i className="h-3 w-3 rounded-full bg-stone-500" />Skipped</span>
            <span className="flex items-center gap-2"><i className="h-3 w-3 rounded-full bg-violet-600" />Review</span>
            <span className="flex items-center gap-2"><i className="h-3 w-3 rounded-full bg-stone-300" />New</span>
          </div>
        </div>
      </aside>
